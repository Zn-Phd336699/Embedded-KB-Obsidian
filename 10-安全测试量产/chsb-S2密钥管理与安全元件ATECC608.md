...
> [!info] 导航
> ⏱ 40min | ★★★★☆ | 前置 [[chsa-S1安全架构与SecureBoot实战]] | → [[chsc-S3-HIL测试台架与Renode仿真]]
...
结论：会话复用（见 [[ch63-网络编程与TLS从socket到安全上云]]）后握手低频化，+25ms 的一次性代价完全值得换来「私钥不出片」。
...
| 设备被盗刷他人固件仍入网 | L1 根信任未烧入，仅靠应用层校验 | 回查 [[chsa-S1安全架构与SecureBoot实战]] 流程补齐 eFuse 公钥哈希 |
...
---
🏷️ #安全 #密钥管理 #ATECC608 #ECDSA #Provisioning | 🔗 [[chsa-S1安全架构与SecureBoot实战]] ← **本章** → [[chsc-S3-HIL测试台架与Renode仿真]] | 📚 [[P10-MOC]]
