...
> [!info] 导航
> ⏱ 15min | ★★☆☆☆ | 前置 [[ch45-实时性理论与调度算法]] | → [[ch52-seL4微内核能力模型形式化验证]]
...
- 深入学习能力模型与形式化验证实践：[[ch52-seL4微内核能力模型形式化验证]]
- RTOS 横向对比：[[ch51-RT-Thread与Zephyr横向对比]]
- 实时性理论基础：[[ch45-实时性理论与调度算法]]
- ARM-A 架构与 SoC 选型：[[ch34-ARM-A架构与国产SoC选型地图]]
