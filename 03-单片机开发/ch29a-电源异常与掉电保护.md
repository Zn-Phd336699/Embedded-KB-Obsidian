...
> [!info] 导航
> ⏱ 35min | ★★★★☆ | 前置 [[ch29-低功耗设计]] | → [[ch30-Bootloader-IAP-OTA固件升级体系]]
...
5. 产测规范中加入随机掉电注入项（联动 [[chsd-S4-量产工程产测工装与老化]]）；MCUboot 场景的状态保存结构同样适用本套路（[[ch89-P3-MCUboot双分区OTA安全升级系统]]）。
...
---
🏷️ #domain/mcu #topic/brownout #topic/lowpower | 🔗 [[ch29-低功耗设计]] ← **本章** → [[ch30-Bootloader-IAP-OTA固件升级体系]] | 📚 [[P3-MOC]]
