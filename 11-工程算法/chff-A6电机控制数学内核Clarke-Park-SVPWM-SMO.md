...
> [!info] 导航
> ⏱ 45min | ★★★★★ | 前置 [[chfe-A5复合与现代控制前馈串级-Smith-LQR]] | → [[chfg-A7运动轨迹规划梯形S曲线前馈跟踪]]
...
---
🏷️ #domain/algorithms #topic/motor-control | 🔗 [[chfe-A5复合与现代控制前馈串级-Smith-LQR]] ← **本章** → [[chfg-A7运动轨迹规划梯形S曲线前馈跟踪]] | 📚 [[P11-MOC]]
