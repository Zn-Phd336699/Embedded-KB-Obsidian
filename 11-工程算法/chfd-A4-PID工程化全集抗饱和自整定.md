...
> [!info] 导航
> ⏱ 45min | ★★★★☆ | 前置 [[chfc-A3姿态解算双雄互补-Mahony-Madgwick]] | → [[chfe-A5复合与现代控制前馈串级-Smith-LQR]]
...
| 负载突变恢复慢且过冲大 | 纯反馈固有局限 | 上可测扰动前馈(见 [[chfe-A5复合与现代控制前馈串级-Smith-LQR]])而非狂加 Kp |
...
---
🏷️ #domain/algorithms #topic/control #PID #抗饱和 #自整定 | 🔗 [[chfc-A3姿态解算双雄互补-Mahony-Madgwick]] ← **本章** → [[chfe-A5复合与现代控制前馈串级-Smith-LQR]] | 📚 [[P11-MOC]]
