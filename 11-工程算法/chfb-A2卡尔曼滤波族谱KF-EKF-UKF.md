...
> [!info] 导航
> ⏱ 45min | ★★★★☆ | 前置 [[chfa-A1数字滤波七件套]] | → [[chfc-A3姿态解算双雄互补-Mahony-Madgwick]]
...
结论：精度需求低于 2° 用互补/Mahony 足够；要 0.5° 级（云台/导航）再上 ESKF——姿态专用简化见 [[chfc-A3姿态解算双雄互补-Mahony-Madgwick]]。
...
3. 变周期采样必须把 dt 传进预测步：P⁻=P+Q·dt；掉电时 x̂/P 存 NoInit 区热启动（[[ch29a-电源异常与掉电保护]]）；
...
- 开源参照：github.com/sfwa/ukf 与 PX4 ECL/EKF2 文档；EKF 的控制端搭档 LQR 见 [[chfe-A5复合与现代控制前馈串级-Smith-LQR]]。
...
---
🏷️ #domain/algorithms #topic/state-estimation | 🔗 [[chfa-A1数字滤波七件套]] ← **本章** → [[chfc-A3姿态解算双雄互补-Mahony-Madgwick]] | 📚 [[P11-MOC]]
