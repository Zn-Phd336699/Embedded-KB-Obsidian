...
> [!info] 导航
> ⏱ 45min | ★★★★☆ | 前置 [[ch74a-自研二进制协议设计规范]] | → [[ch76-I2C协议与排障时钟拉伸总线锁死多主机]]
...
- 冲突根治路线：Modbus 单主制是纪律而非缺陷，真要多主竞争请迁 CAN（[[ch78-CAN-CANFD实战SocketCAN-DBC工作流]]）。
...
---
🏷️ #domain/protocol #topic/uart #topic/modbus | 🔗 [[ch74a-自研二进制协议设计规范]] ← **本章** → [[ch76-I2C协议与排障时钟拉伸总线锁死多主机]] | 📚 [[P8-MOC]]
