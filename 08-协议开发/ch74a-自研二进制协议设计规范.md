...
> [!info] 导航
> ⏱ 40min | ★★★☆☆ | 前置 [[ch74-总线与无线选型总表]] | → [[ch75-UART-RS485与Modbus-RTU实战libmodbus]]
...
多项式族谱与汉明距离推导见 [[chfh-A8校验族谱CRC全家汉明HMAC边界]]。
...
- 云侧衔接：自研协议通常终结于网关，网关之上走 MQTT/CoAP（[[ch80a-MQTT-CoAP云协议本体与实现]]）。
...
---
🏷️ #domain/protocol #topic/protocol #topic/crc | 🔗 [[ch74-总线与无线选型总表]] ← **本章** → [[ch75-UART-RS485与Modbus-RTU实战libmodbus]] | 📚 [[P8-MOC]]
